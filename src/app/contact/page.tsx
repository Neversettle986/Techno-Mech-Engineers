        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-lg border border-gray-100" noValidate>
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-[#DC143C] focus:ring-[#DC143C]' : 'border-gray-300 focus:border-[#DC143C] focus:ring-[#DC143C]'} focus:ring-1 focus:outline-none transition-all outline-none bg-gray-50`}
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        disabled={isSubmitting}
                        className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-[#DC143C] focus:ring-[#DC143C]' : 'border-gray-300 focus:border-[#DC143C] focus:ring-[#DC143C]'} focus:ring-1 focus:outline-none transition-all outline-none bg-gray-50`}
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        disabled={isSubmitting}
                        className={`w-full px-4 py-3 rounded-lg border ${errors.phone ? 'border-[#DC143C] focus:ring-[#DC143C]' : 'border-gray-300 focus:border-[#DC143C] focus:ring-[#DC143C]'} focus:ring-1 focus:outline-none transition-all outline-none bg-gray-50`}
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        disabled={isSubmitting}
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#DC143C] focus:ring-1 focus:ring-[#DC143C] focus:outline-none transition-all outline-none bg-gray-50"
            ...
            <div>
                ...
                <select
                    ...
                    onChange={handleChange}
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border ${errors.subject ? 'border-[#DC143C] focus:ring-[#DC143C]' : 'border-gray-300 focus:border-[#DC143C] focus:ring-[#DC143C]'} focus:ring-1 focus:outline-none transition-all outline-none bg-gray-50`}
                >
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    disabled={isSubmitting}
                    className={`w-full px-4 py-3 rounded-lg border ${errors.message ? 'border-[#DC143C] focus:ring-[#DC143C]' : 'border-gray-300 focus:border-[#DC143C] focus:ring-[#DC143C]'} focus:ring-1 focus:outline-none transition-all outline-none bg-gray-50 resize-none`}
            ...
            <Button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-[#DC143C] hover:bg-[#B01030] text-white py-4 rounded-lg font-semibold text-lg hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed group overflow-hidden relative"
            >
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
                        ...
                        <div className="space-y-6 flex flex-col justify-start">
                            ...
                            <div className="grid gap-8 contact-grid w-full">
                                {contactInfo.map((info, index) => {
                                    const Icon = info.icon;
                                    return (
                                        <div key={index} className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-6 border border-gray-100 contact-card">
                                            <div className="w-12 h-12 bg-[#DC143C]/10 rounded-full flex items-center justify-center flex-shrink-0"><Icon className="text-[#DC143C]" size={24} /></div>
