...
const SparkleNavbar: React.FC<SparkleNavbarProps> = ({
    ...
    const handleClick = (index: number) => {
        // If clicking the current one, just route there (though you are already there)
        // The main reason is to trigger animation only if changing, or just stay.
            ...
            keyframes: [
                ...
                },
                {
                    ...
                    onComplete: () => {
                        ...
                        // Update the state after the animation completes
                        setActiveIndex(index);
                    },
                },
            ],
    ...
    return (
      ...
      `}</style>
            <nav className={cn("navigation-menu", className)} ref={navRef}>
                <ul>
                        ...
                        <li key={item.name} className={index === activeIndex ? "active" : ""}>
                            <button
                                ...
                                className={cn(
                                    ...
                                    index === activeIndex ? "text-[#DC143C]" : "text-[#1F2937] hover:text-[#DC143C]"
                                )}
                            >
                                {item.name}
                            </button>
